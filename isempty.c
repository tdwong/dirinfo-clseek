...
//   T. David Wong		04-12-2026    fixed return code (0 - true, -1 - false)
//
// TODO:
//   - accept multiple arguments - This may not be a good idea (02/18/04)

#define _COPYRIGHT_	"(c) 2004,2005,2026 Tzunghsing David <wong>"
...
#define _PROGRAMVERSION_	"0.70"	/* program version */
...
#define	NONEMPTY_DIR	1		// FALSE
#define	IS_EMPTY_DIR	0		// TRUE
...
main(int argc, char **argv)
{
	...
	*/
	...
	else if (IsDirectory(gTargetDir))
	{
		...
		dirinfo_Find(gTargetDir, &dibuf, &mcbuf, (int) 1, (int) 0, (int) 0);
